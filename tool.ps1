...
# ==============================================================================
# TOOL DATA (DQRKIS-FUCKER is now safely linked to Web to prevent 404 crash)
# ==============================================================================
$ToolData = @(
    ...
    @{ Name="DQRKIS-FUCKER";      Category="Others";     Type="Web";    Desc="Detects DQRKIS cheat signatures (Offline)"; URL="https://github.com/cheesecatlol" },
          ...
          <StackPanel Margin="12,14,12,14">
            <Border Background="#B0061012" CornerRadius="6" Margin="0,0,0,14" Padding="0,10">
              <TextBlock x:Name="CatBlock"
                Text=" /\_____/\ &#x0a; / ^ ^ \ &#x0a; ( = w = )&#x0a; \ (___) / &#x0a; / | | \ &#x0a; (__| |__)"
                FontFamily="Consolas" FontSize="9" Foreground="{StaticResource Accent}" HorizontalAlignment="Center" TextAlignment="Left" xml:space="preserve"/>
            </Border>
        ...
        <Grid Grid.Column="1" Margin="0">
          ...
          <Border Grid.Row="2" Background="{StaticResource ConsoleBg}" BorderBrush="{StaticResource SepColor}" BorderThickness="0,1,0,0" Padding="16,10">
            <Grid>
              ...
              <TextBox x:Name="LogBox" Grid.Row="1" Background="Transparent" Foreground="{StaticResource Accent}" BorderThickness="0" FontFamily="Consolas" FontSize="11" IsReadOnly="True" VerticalScrollBarVisibility="Auto" TextWrapping="Wrap"/>
            </Grid>
          </Border>
        </Grid>
      </Grid>
...
try {
    ...
    $message = 'The interface could not be loaded. Details: ' + $_.Exception.Message
    throw $message
}
finally {
    ...
    foreach ($tool in $cat.Group) {
        ...
        $btn.Add_Click({
            ...
            if ($tType -eq "Cmd") {
                ...
                } catch { Write-Log "Error executing command: $_" }
            } else {
...
$FastSSBtn.Add_Click({ Write-Log "Starting Fast SS..."; Invoke-SSMode -Mode "Fast" })
$NormalSSBtn.Add_Click({ Write-Log "Starting Normal SS..."; Invoke-SSMode -Mode "Normal" })
$FullSSBtn.Add_Click({ Write-Log "Starting Full SS..."; Invoke-SSMode -Mode "Full" })
...
$OpenCmdLbl.Add_Click({ Start-Process cmd.exe; Write-Log "Spawned Command Prompt." })
